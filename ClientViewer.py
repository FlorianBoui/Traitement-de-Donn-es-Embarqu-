...
if __name__ == "__main__":
    ...
    try:
        cv2.namedWindow("Leap motion viewer", cv2.WINDOW_NORMAL)#cv2.WND_PROP_FULLSCREEN)
        cv2.setWindowProperty("Leap motion viewer", cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_NORMAL)#cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
        run(controller)
